...
if ($FTLpid !== 0) {
    ...
    echo ' '.$timezone; ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php print_r('EYE_SPOT'); ?> / <?php print_r( 'ADMIN '); ?></td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <p id="dhcpnotice" lookatme-text="Make sure your router's DHCP server is disabled when using the EYE_SPOT DHCP server!" <?php if (!$DHCP) { ?>hidden<?php } ?>>Make sure your router's DHCP server is disabled when using the TEYE_SPOT DHCP server!</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12">
                            ...
                            <div class="col-md-6">
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>EYE_SPOT domain name</label>
                                                <div class="form-group">
                                                    <div class="input-group">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="danger-area">
                                                        <h4>Potentially dangerous options</h4>Make sure your EYE_SPOT is properly firewalled!
                                                        <div>
                                                        ...
                                                        <p>These options are dangerous on devices
                                                            ...
                                                            EYE_SPOT is properly firewalled. In a typical at-home setup where your EYE_SPOT is
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div>
                                                    ...
                                                    <p>When there is a EYE_SPOT domain set and this box is
                                                ...
                                                <div>
                                                    ...
                                                    <p>All reverse lookups for private IP ranges (i.e., <code>192.168.0.x/24</code>, etc.)
                                                        ...
                                                        local hostnames if the EYE_SPOT is not used as DHCP server.</p>
                                                </div>
                                                <br>
                                                <div>
                                                    ...
                                                    <p>Validate DNS replies and cache DNSSEC data. When forwarding DNS
                                                        queries, EYE_SPOT requests the DNSSEC records needed to validate
                                                ...
                                                <p>Block clients making more than <input type="number" name="rate_limit_count" value="<?php echo $rate_limit_count; ?>" min="0" step="10" style="width: 5em;"> queries within
                                                    ...
                                                    and prevent TEAM getting overwhelmed by rogue clients.
                                                ...
                                                <p>If not configured as your DHCP server, EYE_SPOT typically won't be able to
                                                    determine the names of devices on your local network.  As a
                                                    result, tables such as Top Clients will only show IP addresses.</p>
                                                <p>One solution for this is to configure EYE_SPOT to forward these
                                                ...
                                                <p>If your local network spans 192.168.0.1 - 192.168.0.255, then you will have to input
                                                    ...
                                                    <a href="" rel="noopener" target="_blank">Discourse forum</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div>
                                                ...
                                                <label for="hideNonfatalDnsmasqWarnings"><strong>Hide non-fatal <code>dnsmasq</code> warnings (warnings listed <a target="_blank" href="">here</a>)</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <p class="lookatme" lookatme-text="Warning: EYE_SPOT's query logging is activated. Although the dashboard will hide the requested details, all queries are still fully logged to the pihole.log file.">Warning: EYE_SPOT's query logging is activated. Although the dashboard will hide the requested details, all queries are still fully logged to the pihole.log file.</p>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p>Backup your EYE_SPOT configuration (settings &amp; lists) as a downloadable archive</p>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <p class="help-block">Upload only EYE_SPOT backup files.</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <p>The PHP extension <code>Phar</code> is not loaded. Please ensure it is installed and loaded if you want to use the EYE_SPOT teleporter.</p>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
